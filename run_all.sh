...
echo "所有脚本已同时启动！"
echo "要停止脚本，请使用: kill $TELEGRAM_PID $BINANCE_ANALYSIS_PID $OKX_ANALYSIS_PID $VOLATILITY_PID"
...
# 等待所有进程结束
wait $TELEGRAM_PID $BINANCE_ANALYSIS_PID $OKX_ANALYSIS_PID $VOLATILITY_PID